...
See discussions, stats, and author profiles for this publication at: https://www.researchgate.net/publication/220018231
The 4+1 View Model of Architecture
Article  in  IEEE Software · November 1995
DOI: 10.1109/52.469759 · Source: DBLP
CITATIONS
2,067
READS
64,686
...
290 PUBLICATIONS   15,773 CITATIONS
SEE PROFILE
All content following this page was uploaded by Philippe Kruchten on 19 May 2014.
...
used),
t h e  process view, which captures the concurrency and synchronization aspects of the design,
t h e  physical view, which describes the mapping(s) of the software onto the hardware and reflects its
distributed aspect,

## Page 3

2
t h e  development view, which describes the static organization of the software in its development
environment.
...
3, but in very simplified form—the intent here is just to give a flavor of
...
templates.
4 A class diagram shows a set of classes and their logical relationships: association, usage,
...
The notation for the logical view is derived from the Booch notation
4. It is considerably simplified to take
...
Several styles would fit the process view. For example, picking from Garlan and Shaw’s taxonomy
1 we can
...
(sequences of interactions between objects, and between processes) as described by Rubin and Goldberg
6.
...
Birman et al.
5 or Witt et al.7 for example. The precise method used to construct the mapping is outside of
...
abstractions (classes, mechanisms, processes, subsystems) as indicated by Rubin and Goldberg
6 —
...
Meszaros (BNR), Hofmeister, Nord and Soni (Siemens), Emery and Hilliard (Mitre)
8, but we have found
